...
import ru.bagrusss.weatherapp.ui.flow.home.screens.cities.CitiesStateMapper
import ru.bagrusss.weatherapp.ui.flow.home.screens.cities.CitiesViewModel
import javax.inject.Inject
import javax.inject.Provider

@Module
internal abstract class CitiesModule : BaseFragmentModule {
    ...
    @Binds
    @FragmentScope
    abstract fun bindStateMapper(stateMapper: CitiesStateMapper): MviStateMapper<DomainState, UIState>
    @Module
    companion object {
        ...
        @JvmStatic
        @FragmentScope
        fun provideViewModel(viewModelProvider: ViewModelProvider): ViewModel = viewModelProvider[CitiesViewModel::class.java]
...
internal class ViewModelFactory @Inject constructor(
    provider: Provider<CitiesViewModel>
) : DiViewModelFactory<CitiesViewModel>(provider)
